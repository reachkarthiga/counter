package com.personal_app.counter.savedCounters
...
class SavedCounters : Fragment() {
    ...
    private fun showEditDialog(counter: Counter) {
        ...
        view.button.setOnClickListener {
            ...
            if (view.edittext.text.toString().trim() != counter.name &&
                !viewModel.checkCounterAvailability(view.edittext.text.toString().trim())) {
