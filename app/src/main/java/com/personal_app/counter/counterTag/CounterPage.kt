package com.personal_app.counter.counterTag
...
class CounterPage : Fragment() {
    ...
    private fun showEditTagDialog(tag: Tags) {
        ...
        val builder: AlertDialog = AlertDialog.Builder(requireContext()).create()
        ...
        view.edittext.filters = arrayOf(InputFilter.LengthFilter(20))
    ...
    private fun showGoToDialog() {
        ...
        view.edittext.filters = arrayOf(InputFilter.LengthFilter(4))
